                ...
                <div className="flex z-10 flex-col justify-center items-start px-7 py-8  rounded-xl bg-neutral-900 ">
                    ...
                    <div className="flex md:flex-row flex-col">
                        <div className="mt-5 md:text-xl text-sm font-medium md:leading-10 mb-3 max-md:mb-10 md:w-2/4 justify-start">
                            Once we settle on a design we break down the Project into tasks and start working on the development side of things. This is the official beginning of our develpopment contract.
                        </div>
                        <div className="flex md:w-2/4 md:justify-end">
                            <Image alt="Book a Call" width={400} height={400} src={'/terms.svg'} />
                        </div>
                    </div>
                </div>
            </div>
