...
export const ContainerScroll = ({
    ...
    return (
        <div
            className="h-[10rem] md:h-[45rem] flex items-center justify-center relative p-2 mt-20 py-20 md:mt-0 md:pt-0"
            ref={containerRef}
        >
            <div
...
export const Card = ({
    ...
    return (
        <motion.div
            ...
            className="relative max-w-5xl -mt-12 mx-auto w-full border-2 border-[#a1c1c1] pl-12 py-[6px] pr-16 bg-[#0c0304] rounded-[30px]"
        >
